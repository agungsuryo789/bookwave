			...
			<v-container fluid>
				<v-row class="row-hero-1">
					...
					>
						...
						>
							<img
								src="@/assets/image/underline-1.svg"
								height="10"
							/>
							<img
								src="@/assets/image/underline-2.svg"
								height="10"
							/>
						</div>
						<p class="pr-5 home-hero-text" style="font-size:18px;">
							Pelajari lebih dalam topik favorit Anda dengan buku
							audio lengkap. Baca atau dengarkan ide-ide kunci
							dari judul nonfiksi terlaris dalam 15 menit. Temukan
							perspektif baru dengan acara dan podcast eksklusif.
						</p>
