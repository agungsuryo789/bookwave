<template>
	<v-col class="mt-8" cols="12">
		...
		<v-row justify="center">
			<v-col cols="6" md="4" align="center">
				<v-btn :elevation="8" block="true"><v-icon dark left>mdi-google</v-icon>Sign in with Google</v-btn>
			</v-col>
		</v-row>
		<v-row justify="center">
			<v-col cols="6" md="4" align="center">
				<v-btn :elevation="8" block="true"><v-icon dark left>mdi-facebook</v-icon>Sign in with Facebook</v-btn>
			</v-col>
		</v-row>
		<v-row justify="center">
			<v-col cols="6" md="4" align="center">
